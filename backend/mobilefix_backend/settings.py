"""
Django settings for mobilefix_backend project.
"""
...
ROOT_URLCONF = 'mobilefix_backend.urls'
...
WSGI_APPLICATION = 'mobilefix_backend.wsgi.application'
...
ALLOWED_DOCUMENT_TYPES = config('ALLOWED_DOCUMENT_TYPES', default='pdf,doc,docx').split(',')
